    ...
    <section className="relative overflow-hidden bg-ink">
      ...
      <div className="relative z-10 mx-auto w-full max-w-7xl px-6 py-16 sm:py-24 md:py-32 lg:py-40">
        <PageHeading
          title={
            <>
              Start <span className="text-orange">Order</span>
            </>
          }
          description="Quickly order your favorite dishes online and enjoy convenient delivery or pickup options for a satisfying dining experience."
        />
      </div>
    </section>
  );
